...
import com.company.creational.factorymethod.ejemplo2.EnemigoFactory;
import com.company.creational.factorymethod.ejemplo2.Enemigos;
import com.company.creational.factorymethod.ejemplo2.TypeEnemigo;
...
public class Main {
    ...
    private static void probarEjemploFactoryMethod(){
        Enemigos enemigos = EnemigoFactory.builEnemigo(TypeEnemigo.ENEMIGOB);
        enemigos.ataque();
    }
}
